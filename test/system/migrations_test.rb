...
class MigrationsTest < ApplicationSystemTestCase
  ...
  test "creating a Migration" do
    ...
    fill_in "Adddatetokyujins", with: @migration.AddDateToKyujins
    fill_in "Cojous", with: @migration.cojous
    fill_in "Honsyas", with: @migration.honsyas
    fill_in "Kinmusonotas", with: @migration.kinmusonotas
    fill_in "Shitens", with: @migration.shitens
