...
class MigrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create migration" do
    assert_difference('Migration.count') do
      post migrations_url, params: { migration: { AddDateToKyujins: @migration.AddDateToKyujins, cojous: @migration.cojous, honsyas: @migration.honsyas, kinmusonotas: @migration.kinmusonotas, shitens: @migration.shitens } }
    end
  ...
  test "should update migration" do
    patch migration_url(@migration), params: { migration: { AddDateToKyujins: @migration.AddDateToKyujins, cojous: @migration.cojous, honsyas: @migration.honsyas, kinmusonotas: @migration.kinmusonotas, shitens: @migration.shitens } }
